...
resource "cloudflare_zero_trust_tunnel_cloudflared" "home_cloud" {
...
resource "cloudflare_zero_trust_tunnel_cloudflared_config" "home_cloud" {
  account_id = var.cloudflare_account_id
  tunnel_id  = cloudflare_zero_trust_tunnel_cloudflared.home_cloud.id
